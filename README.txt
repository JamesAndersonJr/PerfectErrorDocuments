...
-----------------------------------------------------------------------
 ...
 2. Open 'config.php' located inside '/error_documents/config/' folder, with your favorite HTML/PHP code editor (Notepad++, obtainable at: [ https://notepad-plus-plus.org ] is highly recommended).
