...
$meta_pg_title = 'Error (401) - Unauthorized';

$meta_pg_descr = '“Unauthorized” Error (401). This server could not verify that you are authorized to access the document requested.';

$meta_pg_image = $cur_site_fqdn.'/error-documents/images/err-og-img.png';

$meta_pg_kywds = 'error, error 401, exception, authorization, required, unauthorized, authorize, authenticate, credentials, access, entry, denied, blocked, forbidden, disallowed, prohibited, banned, barred, refused, off-limits, rejected, withheld, inhibited, not allowed, inaccessible, private, exclusive, confidential, login';
...
<div class="main_ctnr_div">
	...
	<div class="sub_ctnr_div">
		...
		<div class="dialog">
			...
			<h1 class="txt_trsfm_cap_forc">Authorization Required</h1>

			<p><span class="txt_trsfm_cap_forc">This</span> server could not verify that you are authorized to access the document requested. <span class="txt_trsfm_cap_forc">Either</span> you supplied the wrong credentials (e.g., a bad password), or your browser doesn't understand how to supply the credentials required.</p>
