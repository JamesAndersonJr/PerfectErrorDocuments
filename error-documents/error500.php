...
$meta_pg_title = 'Error (500) - Internal Server Error';

$meta_pg_descr = '“Internal Server Error” (500). An unexpected internal server error has occurred. Please report this bug to the webmaster, if you would like to see it resolved.';

$meta_pg_image = $cur_site_fqdn.'/error-documents/images/err-og-img.png';

$meta_pg_kywds = 'error, error 500, exception, internal, server, fault, flaw, glitch, failure, malfunction, broken, bug, problem, defect, defective, unresolved, unresponsive, issue, not working, nonworking, dysfunctional';
