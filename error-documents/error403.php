...
$meta_pg_title = 'Error (403) - Forbidden';

$meta_pg_descr = '“Access Forbidden” Error (403). Access to this resource has been forbidden.';

$meta_pg_image = $cur_site_fqdn.'/error-documents/images/err-og-img.png';

$meta_pg_kywds = 'error, error 403, exception, access, entry, denied, blocked, forbidden, disallowed, prohibited, banned, barred, refused, off-limits, rejected, withheld, inhibited, not allowed, inaccessible, private, exclusive, confidential';
...
<div class="main_ctnr_div">
	...
	<div class="sub_ctnr_div">
		...
		<div class="dialog">
			...
			<h1 class="txt_trsfm_cap_forc">Access Denied</h1>

			<p><span class="txt_trsfm_cap_forc">You</span> do not have the proper authorization to access this resource. <span class="txt_trsfm_cap_forc">If</span> you came to this page via a link, please inform the owner(s) of that page.</p>
