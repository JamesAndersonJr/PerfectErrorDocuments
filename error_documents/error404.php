...
$meta_Tag_Site_Name = "Error - [404] Not Found";

$meta_Tag_Description = "The requested resource could not be found.";

$meta_Tag_Site_Image = $current_Website_Domain_Name."/error_documents/php/open_graph_image.php";

$meta_Tag_Key_Words = "error, error 404, exception, not found, nonexistent, empty, null, void, devoid, missing, blank, vacant, vacated, gone, unavailable";
