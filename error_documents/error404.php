...
$titl_tag_pg_titl = 'Error - [404] Not Found';

$meta_tag_pg_descr = 'The requested resource could not be found.';

$meta_tag_pg_img = $cur_site_fqdn.'/error_documents/php/og_img.php';

$meta_tag_pg_kywrds = 'error, error 404, exception, not found, nonexistent, empty, null, void, devoid, missing, blank, vacant, vacated, gone, unavailable';
...
<div class="main_cont_div">
	...
	<div class="sub_cont_div">
		...
		<h1><span class="txt_trsfm_cap_forc">The</span> page you were looking for doesn&#8217;t exist.</h1>

		<p><span class="txt_trsfm_cap_forc">You</span> may have mistyped the address, or the page may have moved.</p>
