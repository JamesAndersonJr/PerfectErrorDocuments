...
$titl_tag_pg_titl = 'Error - [401] Unauthorized';

$meta_tag_pg_descr = 'Authorization is required to access this resource.';

$meta_tag_pg_img = $cur_site_fqdn.'/error_documents/php/og_img.php';

$meta_tag_pg_kywrds = 'error, error 401, exception, authorization, required, unauthorized, authorize, authenticate, credentials, access, entry, denied, blocked, forbidden, disallowed, prohibited, banned, barred, refused, off-limits, rejected, withheld, inhibited, not allowed, inaccessible, private, exclusive, confidential, login';
...
<div class="main_cont_div">
	...
	<div class="sub_cont_div">
		...
		<div class="dialog">
			...
			<p><span class="txt_trsfm_cap_forc">This</span> server could not verify that you are authorized to access the document requested. Either you supplied the wrong credentials (e.g., a bad password), or your browser doesn't understand how to supply the credentials required.</p>
