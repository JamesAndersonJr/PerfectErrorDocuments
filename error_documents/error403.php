...
$titl_tag_pg_titl = 'Error - [403] Forbidden';

$meta_tag_pg_descr = 'Access to this resource has been forbidden.';

$meta_tag_pg_img = $cur_site_fqdn.'/error_documents/php/og_img.php';

$meta_tag_pg_kywrds = 'error, error 403, exception, access, entry, denied, blocked, forbidden, disallowed, prohibited, banned, barred, refused, off-limits, rejected, withheld, inhibited, not allowed, inaccessible, private, exclusive, confidential';
...
<div class="main_cont_div">
	...
	<div class="sub_cont_div">
		...
		<div class="dialog">
			...
			<p><span class="txt_trsfm_cap_forc">You</span> do not have the proper authorization to access this resource. If you came to this page via a link, please inform the owner(s) of that page.</p>
